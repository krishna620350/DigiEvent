...
import Validation from "../Validations/VendorValidations.js";
...
export default class VendorController {
    ...
    InsertData = async (req, res) => {
        ...
        try {
            ...
            // console.log(vendorDocuments,req.body.TicketCount)
            const validation = new Validation(vendorDocuments, req.body.TicketCount);
